...
namespace MVAManagement.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<CourtHearingType> CourtHearingTypes { get; set; }
        public DbSet<VehicleDetail> VehicleDetails { get; set; }
        public DbSet<ClaimantInjury> ClaimantInjuries { get; set; }
        public DbSet<DocumentChecklist> DocumentChecklists { get; set; }
        public DbSet<LitigationEvent> LitigationEvents { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CourtHearingType>(entity =>
            {
            ...
            modelBuilder.Entity<LitigationEvent>(entity =>
            {
